...
export const updateTopic = async (req, res) => {
    const { id } = req.params;
    const { groupid, leaderid, leader_email, member1, member2, member3, membercount, research_topic, research_field, description, status } = req.body;
    ...
    try {
        ...
        const updatedTopic = { groupid, leaderid, leader_email, member1, member2, member3, membercount, research_topic, research_field, description, status, _id: id };
